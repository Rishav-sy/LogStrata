              ...
              <AnimatePresence mode="wait">
                {step === "form" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">
                        {mode === "signin" ? "Welcome Developer" : "Create Account"}
                      </h1>
                      <p className="text-[1.8rem] text-white/70 font-light">
                        {mode === "signin" ? "Sign in to your console" : "Get started with LogStrata"}
                      </p>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <form onSubmit={mode === "signin" ? handleEmailSignIn : handleEmailSignUp} className="space-y-4 text-left">
                        <div className="space-y-3">
                          <input 
                            ...
                            className="w-full backdrop-blur-[1px] text-white border border-white/10 bg-white/5 rounded-full py-3 px-6 focus:outline-none focus:border-white/30 text-center"
                            required
                          />
                          <input 
                            type="password" 
                        ...
                        {error && (
                          <div className="text-red-400 text-xs py-1 text-center font-mono">
                            {error}
                          </div>
                        )}
                        ...
                        <motion.button 
                          type="submit"
                          disabled={loading}
                          className="w-full rounded-full bg-white text-black font-semibold py-3 hover:bg-white/90 transition-colors flex items-center justify-center gap-2 cursor-pointer mt-2"
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">
                        {mode === "signin" ? "You're in!" : "Registered!"}
                      </h1>
                      <p className="text-[1.25rem] text-white/50 font-light">
                        {mode === "signin" ? "Welcome back" : "Confirm email if required, or continue"}
                      </p>
                    </div>
